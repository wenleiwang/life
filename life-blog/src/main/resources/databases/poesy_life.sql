...
CREATE TABLE `blog_classify`  (
  `classify_id` int(11) UNSIGNED ZEROFILL NOT NULL COMMENT '分类ID',
...
CREATE TABLE `blog_comment`  (
  ...
  `comment_parent` int(11) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '父级评论ID，0-表示1级评论',
...
CREATE TABLE `blog_user`  (
  ...
  `real_age` int(3) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '真实年龄',
  ...
  `deleted` tinyint(1) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '删除状态',
