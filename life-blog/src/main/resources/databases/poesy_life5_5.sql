...
-- ----------------------------
INSERT INTO `blog_article` VALUES (1, 'articleName22', 'articleDescription', 'articleBody', 1, '2020-11-06 17:18:00', '2020-11-06 18:18:45', 1, 0, 0, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (2, 'articleName', 'articleDescription', 'articleBody', 1, '2020-11-06 17:11:19', '2020-11-06 17:11:19', 0, 0, 0, 1, 1, 1, 1, 'http://localhost', NULL);
INSERT INTO `blog_article` VALUES (3, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 1, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (4, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 1, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (5, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 1, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (6, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 0, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (7, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 0, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (8, 'articleName11', 'articleDescription', 'articleBody', 1, NULL, NULL, 0, NULL, NULL, 1, 1, 1, 0, 'http://localhost1', 1);
INSERT INTO `blog_article` VALUES (9, '1', '2', NULL, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `blog_article` VALUES (16, '沙发上阿发FDAWFE', '分分啊发分为afaSD', '分分啊发分为afaSD', 1, '2020-12-30 14:02:46', '2020-12-30 14:02:46', 0, 0, 0, 0, 1, 1, 1, 'article.getArticleImgUrl()', 0);
INSERT INTO `blog_article` VALUES (20, '为预览提供的测试文档', '# 这是一级标题\n巴拉巴拉\n## 这里是二级标题\n弗拉随机发\n## 这是二级标题\n答非啊\n### 这是二级标题的三级标题1\n发斯蒂芬就爱看\n#### 这是四级标题1\n额发而发\n#### 这里是四级标题', '# 这是一级标题\n巴拉巴拉\n## 这里是二级标题\n弗拉随机发\n## 这是二级标题\n答非啊\n### 这是二级标题的三级标题1\n发斯蒂芬就爱看\n#### 这是四级标题1\n额发而发\n#### 这里是四级标题2\n大师傅IE\n### 这是二级标题的三级标题2\n范德萨见覅额\n----\n>这里是引用\n\n这里是代码\n```java\npublic ResponseBase updateArticle(@RequestBody ArticleRequest article){\n        UserInfo userContext = UserContext.getUserContext();\n        if(userContext == null){\n            return new ResponseBase().fail(\"用户登录失败，请重新登录！\");\n        }\n        return adminArticleService.updateArticle(article,userContext);\n    }\n```', 1, '2020-12-30 16:00:24', '2020-12-30 16:00:24', 0, 0, 0, 0, 1, 1, 1, 'article.getArticleImgUrl()', 0);
INSERT INTO `blog_article` VALUES (21, '个人年终工作总结', '个人年终工作总结\n时间飞逝，转眼已经来到这里四个月，回顾这段时间的成长，收获颇多，感慨颇多。刚来时，在领导和同事的带领下熟悉业务，同时也着手参与小部分功能。在工作上，项目进度把控合理，需求分析到位，大', '个人年终工作总结\n时间飞逝，转眼已经来到这里四个月，回顾这段时间的成长，收获颇多，感慨颇多。刚来时，在领导和同事的带领下熟悉业务，同时也着手参与小部分功能。在工作上，项目进度把控合理，需求分析到位，大家一起沟通愉快。在生活上领导同事的亲切与关怀，让我洋溢着喜悦。身处这样工作环境下，我感到了我的进步和喜悦，在这里感谢我的领导和同事对我的关怀与帮助。\n一、本年度工作回顾\n1.参与熟悉历史业务。在我读取研究成熟业务部分时，严谨的逻辑、新颖的思维，对我的思维逻辑有极大的提升；在我使用工具时，由于涉及工具广泛且要求精准，对我的技术广度深度都做了更深层次的要求。\n2.参与存房2.0业务的部分开发工作。存房2.0业务整合C端、B端、S端，成为一个更为完整的业务功能，它打通了CBS三端的业务数据的交互，这里需要更为严谨的逻辑，更为准确的数据，更为有效的沟通，做好这项工作对沟通和技术都提出高要求。\n参与进这样的工作中，紧跟着项目我感到了我的进步。端正态度，热爱本职工作，尽到自己本份，尽力完成应该做的事情，这是我的优点，在努力工作时也收获到了技术能力的成长，但也感到自己的不足，在以后的时光抓紧时间弥补自己的不足。\n二、来年工作的展望\n1.严于律己。事业是学生事业的延续在空闲时，深度学习基础知识，不断扩展自己的知识储备以达到广度的积累，使自己技术深度广度得到提高。\n2. 加强沟通，同事之间要坦诚、宽容、沟通和信任。工作中有些问题往往就是因为没有及时沟通引起的，以后工作中要与领导与同事加强沟通。\n3.依然热爱工作，以端正的态度，尽到自己的本分，尽力完成应进之事。\n4.“士不可以不弘毅，任重而道远”，希望自己的工作可以作为公司最坚固的一块砖。 \n在以后的工作中，我一定会扬长避短，克服不足、认真学习、发奋工作、积极进取、尽快成长，把工作做的更好。我已经准备好我全部的心和热情，让新的一年和新的学习过程早点开始。\n', 1, '2020-12-30 16:14:17', '2020-12-30 16:14:17', 0, 0, 0, 0, 1, 1, 1, 'article.getArticleImgUrl()', 0);
INSERT INTO `blog_article` VALUES (22, '2否232水电费', '# 这是一级标题\n巴拉巴拉\n## 这里是二级标题\n弗拉随机发\n## 这是二级标题\n答非啊\n### 这是二级标题的三级标题1\n发斯蒂芬就爱看\n#### 这是四级标题1\n额发而发\n#### 这里是四级标题', '# 这是一级标题\n巴拉巴拉\n## 这里是二级标题\n弗拉随机发\n## 这是二级标题\n答非啊\n### 这是二级标题的三级标题1\n发斯蒂芬就爱看\n#### 这是四级标题1\n额发而发\n#### 这里是四级标题2\n大师傅IE\n### 这是二级标题的三级标题2\n范德萨见覅额\n----\n>这里是引用\n\n这里是代码\n```java\npublic ResponseBase updateArticle(@RequestBody ArticleRequest article){\n        UserInfo userContext = UserContext.getUserContext();\n        if(userContext == null){\n            return new ResponseBase().fail(\"用户登录失败，请重新登录！\");\n        }\n        return adminArticleService.updateArticle(article,userContext);\n    }\n```', 1, '2020-12-30 16:51:54', '2020-12-30 16:51:54', 0, 0, 0, 0, 1, 1, 1, 'article.getArticleImgUrl()', 0);
...
INSERT INTO `blog_classify` VALUES (5, 'java', NULL, NULL, NULL, 0);
